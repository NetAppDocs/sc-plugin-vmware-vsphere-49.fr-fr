...
.Étapes
. Dans le volet de gauche du plug-in SCV, cliquez sur *groupes de ressources*, sélectionnez un groupe de ressources, puis sélectionnez image:scpivs44_image38.png["Icône de lecture"] *Exécuter maintenant* pour démarrer la sauvegarde.
