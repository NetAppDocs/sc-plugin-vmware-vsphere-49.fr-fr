...
| Les machines virtuelles et les VMDK | Sauvegardes primaires | Environnements NFS : SnapRestore de fichier unique ONTAP
Environnements VMFS : clonage et montage avec Storage VMotion 


| Les machines virtuelles et les VMDK | Sauvegardes secondaires | Environnements NFS : SnapRestore de fichier unique ONTAP
Environnements VMFS : clonage et montage avec Storage VMotion 


| Machines virtuelles et VMDK supprimés | Sauvegardes primaires | Environnements NFS : SnapRestore de fichier unique ONTAP
Environnements VMFS : clonage et montage avec Storage VMotion 


| Machines virtuelles et VMDK supprimés | Sauvegardes secondaires | Environnements NFS : clonage et montage avec Storage VMotion
Environnements VMFS : clonage et montage avec Storage VMotion 


| Les machines virtuelles et les VMDK | Sauvegardes primaires cohérentes avec les machines virtuelles | Environnements NFS : SnapRestore de fichier unique ONTAP
Environnements VMFS : clonage et montage avec Storage VMotion 


| Les machines virtuelles et les VMDK | Sauvegardes secondaires cohérentes au niveau des machines virtuelles | Environnements NFS : clonage et montage avec Storage VMotion
Environnements VMFS : clonage et montage avec Storage VMotion 
...
Environnements NFS :
* ONTAP Single File SnapRestore si vous utilisez ONTAP version 9.10.1 et ultérieure
* Cloner et monter avec Storage VMotion sur les versions précédentes de ONTAP
...
* Restauration de SnapMirror ONTAP si vous utilisez ONTAP version 9.10.1 ou ultérieure
...
Voir https://kb.netapp.com/mgmt/SnapCenter/SCV_clone_or_restores_fail_with_error_'Host_Unresolved_volumes_is_null'#["Article de la base de connaissances : le clone ou les restaurations de SCV échouent avec l'erreur « les volumes non résolus de l'hôte sont nuls"^] pour plus d'informations sur l'erreur.
